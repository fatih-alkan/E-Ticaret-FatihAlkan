...
export default function FeaturedProducts() {
    return (
        <>
            <div className="flex flex-col items-center h-[2100px] w-full">
                ...
                {featuredImages.map((img, index) => ( 
                    <div key={index} className="max-w-[328px] max-h-[606px] mt-10 pb-10 rounded-lg overflow-hidden shadow-lg bg-white">
